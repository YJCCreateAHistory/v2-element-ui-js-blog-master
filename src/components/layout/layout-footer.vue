    ...
    <div id="layout-footer">
        <div class="footer-main">
            ...
            <div class="footer-item">
                ...
                <div><a target="_blank" class="out-link" href="https://juejin.cn/user/1500172650291319">每周精选</a></div>
                <div><a target="_blank" class="out-link" href="https://www.jmjc.tech/">简明教程</a></div>
                <div><a target="_blank" class="out-link" href="https://juejin.cn/user/1500172650291319">CCCJCxx的官方网站</a></div>
            </div>
            <div class="footer-item">
