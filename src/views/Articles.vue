        ...
        <div class="site-content animate">
            ...
            <main class="site-main">
                <article class="hentry">
                    ...
                    <!-- 正文输出 -->
                    <div class="entry-content" v-highlight v-html="form.content">
                    ...
                    <section-title>
                        <footer class="post-footer">
                            ...
                            <div class="post-tags">
                                ...
                                <router-link title="分类" :to="`/category/${form.className}`">Web</router-link>
                            </div>
                        </footer>
                    </section-title>
                    ...
                    <div class="open-message">
                        <p>声明：xc-blog博客|版权所有，违者必究|如未注明，均为原创|本网站采用<a href="https://creativecommons.org/licenses/by-nc-sa/3.0/" target="_blank">BY-NC-SA</a>协议进行授权</p>
                        <p>转载：转载请注明原文链接 - <a href="/">{{form.title || 'xc-blog'}}</a></p>
                    </div>
                    <!--评论-->
                    <div class="comments">
